...
insert into accounts (account_id, user_id) values (1, 1);

insert into account_transation (transaction_id, account_id, amount, category, memo, transaction_date) values (1, 1, -20000, 'FOOD', '점심 식사', '2024-11-06T12:00:00');
